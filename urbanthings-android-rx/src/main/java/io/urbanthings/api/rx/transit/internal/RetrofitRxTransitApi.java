...
package io.urbanthings.api.rx.transit.internal;
...
public interface RetrofitRxTransitApi {

    @GET("static/transitstops")
    Single<Result<ApiResponse<List<TransitStop>>>> getStops(@Query("minlat") double minLat, @Query("maxlat") double maxLat,
    ...
    @GET("static/transitstops")
    Single<Result<ApiResponse<List<TransitStop>>>> getStops(@Query("centerLat") double centerLat, @Query("centerLng") double centerLng,
    ...
    Single<Result<ApiResponse<PlacePointList>>> getPlacePoints(@Query("minlat") double minLat, @Query("maxlat") double maxLat,
                                                     @Query("minlng") double minLng, @Query("maxlng") double maxLng,
    ...
    @GET("static/placepoints")
    Single<Result<ApiResponse<PlacePointList>>> getPlacePoints(@Query("centerlat") double centerLat, @Query("centerlng") double centerLng,
    ...
    Single<Result<ApiResponse<PlacePointList>>> searchPlacePoints(@Query("name") String name, @Query("lat") double lat, @Query("lng") double lng,
    ...
    Single<Result<ApiResponse<List<TransitDetailedRouteInfo>>>> searchRoutes(@Query("lineName") String lineName,
    ...
    Single<Result<ApiResponse<List<TransitDetailedRouteInfo>>>> getRoutes(@Query("agencyID") String agencyId,
                                                                             @Query("importSource") String importSource,
                                                                             @Query("version") String version,
                                                                             @Query("apikey") String apiKey);

    @GET("static/routes/info/CallingAtStop")
    Single<Result<ApiResponse<List<TransitDetailedRouteInfo>>>> getRoutesForStop(@Query("stopID") String stopId,
                                                                          @Query("version") String version,
                                                                          @Query("apikey") String apiKey);

    @GET("static/trips")
    Single<Result<ApiResponse<List<TransitTrip>>>> getTrips(@Query("routeID") String routeId,
    ...
    Single<Result<ApiResponse<List<TransitTripCalendarGroup>>>> getTripsByCalendar(@Query("routeID") String routeId,
                                                                                   @Query("includePolyLines") Boolean includePolyLines,
                                                                                   @Query("includeStopCoordinates") Boolean includeStopCoordinates,
                                                                                   @Query("version") String version,
                                                                                   @Query("apikey") String apiKey);
    ...
    Single<Result<ApiResponse<TransitStopScheduledCalls>>> getStopCalls(@Query("stopID") String stopId,
    ...
    @GET("static/routes")
    Single<Result<ApiResponse<DirectionsResponse>>> getRoute(@Query("routeID") String routeId,
    ...
    @GET("rti/report")
    Single<Result<ApiResponse<TransitStopRTIResponse>>> getStopReport(@Query("stopID") String stopId,
    ...
    @GET("rti/stopboard")
    Single<Result<ApiResponse<StopBoardResponse>>> getStopboard(@Query("stopID") String stopId,
                                                      @Query("maxItems") Integer maxItems,
    ...
    Single<Result<ApiResponse<List<ResourceStatus>>>> getResourceStatus(@Query("stopIDs") String stopId,
                                                                        @Query("version") String version,
                                                                        @Query("apikey") String apiKey);

    @POST("plan/directions")
    Single<Result<ApiResponse<DirectionsResponse>>> getDirections(@Body DirectionsRequest request,
                                                                  @Query("version") String version,
                                                                 @Query("apikey") String apiKey);
